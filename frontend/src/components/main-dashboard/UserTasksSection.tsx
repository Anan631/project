...
import { Shield, Home, HardHat, Sparkles, Zap, TrendingUp } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20 rounded-full mb-6 border border-blue-100 dark:border-blue-800/30">
            ...
            <span className="text-sm font-semibold text-blue-700 dark:text-blue-300">أدوار ومسؤوليات</span>
          </div>
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
            لكل مستخدم دور محدد لضمان تنظيم العمل وتحقيق أقصى استفادة من المنصة.
          </p>
        </motion.div>
