...
import { CheckCircle, Eye, Target, Sparkles, Zap, TrendingUp } from "lucide-react";
...
const whyUsData = [
  {
    ...
    description: "نحن نستخدم معايير هندسية صارمة لضمان أن كل حساب يتم على منصتنا هو دقيق وموثوق، مما يمنحك الثقة لاتخاذ قرارات سليمة.",
  ...
  },
  {
    ...
    description: "نوفر جسرًا من الثقة بين المهندس والمالك من خلال تقارير واضحة ومتابعة حية للمشروع، مما يضمن أن يكون الجميع على اطلاع دائم.",
  ...
  },
  {
    ...
    description: "تم تصميم أدواتنا لتبسيط العمليات المعقدة، مما يوفر ساعات من العمل اليدوي ويسمح لك بالتركيز على ما هو أكثر أهمية: نجاح مشروعك.",
...
const WhyUsSection = () => {
  ...
  return (
    <section className="relative py-20 overflow-hidden bg-gradient-to-b from-white to-gray-50/50 dark:from-gray-900 dark:to-gray-950">
      {/* خلفيات زخرفية */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-red-500 via-blue-500 to-emerald-500"></div>
        <div className="absolute top-1/4 -left-20 w-64 h-64 bg-gradient-to-br from-red-100 to-transparent rounded-full blur-3xl opacity-20 dark:opacity-10"></div>
        <div className="absolute bottom-1/4 -right-20 w-64 h-64 bg-gradient-to-br from-blue-100 to-transparent rounded-full blur-3xl opacity-20 dark:opacity-10"></div>
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-4xl h-48 bg-gradient-to-r from-emerald-500/5 to-cyan-500/5 blur-3xl rounded-full"></div>
      </div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20 rounded-full mb-6 border border-blue-100 dark:border-blue-800/30">
            ...
            <span className="text-sm font-semibold text-blue-700 dark:text-blue-300">مزايا منصتنا</span>
          </div>
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
            نحن لا نقدم مجرد أرقام، بل نقدم الثقة والوضوح في كل خطوة من خطوات مشروعك الإنشائي.
          </p>
