      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
        {calculationCards.map((card, index) => (
          <Link
            ...
            href={
              card.id === 'foundation'
                ? `/engineer/projects/${projectId}/concrete-cards/foundation`
                : card.id === 'cleaning-slab'
                ? `/engineer/projects/${projectId}/concrete-cards/cleaning-slab`
                : card.id === 'column-base'
                ? `/engineer/projects/${projectId}/concrete-cards/column-footings`
                : card.id === 'ground-bridges'
                ? `/engineer/projects/${projectId}/concrete-cards/ground-bridges`
                : card.id === 'columns'
                ? `/engineer/structural-elements/columns?projectId=${projectId}`
                : '#'
            }
            className={cn(
              "group block h-full",
