        ...
        <body>
          <div class="container">
            ...
            <table style="margin-top: 30px;">
              <thead style="background: linear-gradient(135deg, #2563eb, #1e40af);">
                <tr>
                  <th>الإجمالي</th>
                  <th>الكمية</th>
                  <th>البند</th>
              ...
              <tbody>
                ...
                ` : ''}
                <tr style="font-weight: 900; background: linear-gradient(to right, #f0f4ff, #e8ecff);">
                  <td>${(() => {
